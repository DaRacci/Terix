...
public enum Option {
    ...
    SKILL_LEVEL_REQUIREMENTS_MULTIPLIER("origin-level-requirements-multiplier", OptionType.DOUBLE),
    ENABLE_SKILL_COMMANDS("enable-origin-commands", OptionType.BOOLEAN),
    ...
    SKILL_MONEY_REWARDS_ENABLED("origin-money-rewards.enabled", OptionType.BOOLEAN),
    SKILL_MONEY_REWARDS_BASE("origin-money-rewards.base", OptionType.DOUBLE),
    SKILL_MONEY_REWARDS_MULTIPLIER("origin-money-rewards.multiplier", OptionType.DOUBLE),
    // Leveler options
    ...
    // Origin options (not including source types)
